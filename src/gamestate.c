...
gameState_settings_struct gameState_settings[NUM_GAMESTATES] = {
    // GAMESTATE_KONAMI_LOGO
    {
        ...
        gamestate_init,
        {
            ...
            GSS_SLOT(0x20, CAMERA_OBJ_06D), GSS_SLOT(0x20, CAMERA_CAMERAMGR), GSS_SLOT(0x20, UPDATE_GAME_SOUND),  GSS_SLOT(0x20, FIGURE_UPDATE),
    ...
    // GAMESTATE_GAMEPLAY
    {
        ...
        gamestate_init,
        {
            ...
            GSS_SLOT(0x07, ENGINE_GAMEPLAYMGR), GSS_SLOT(0x20, CAMERA_OBJ_06D),    GSS_SLOT(0x20, CAMERA_CAMERAMGR), GSS_SLOT(0x20, UPDATE_GAME_SOUND),
