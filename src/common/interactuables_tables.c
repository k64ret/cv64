...
interactuables_settings interactuables_settings_table[] = {
    ...
    {ITEM_KIND_TEXT_SPOT, 0x0006, 0x0154, {0x00, 0x00}, 0x00000200, STAGE_OBJECT_LEVER, 0x0001, 5, {0x00, 0x00}},
    {ITEM_KIND_TEXT_SPOT, 0x0006, 0x0154, {0x00, 0x00}, 0x00000400, STAGE_OBJECT_LEVER, 0x0002, 5, {0x00, 0x00}},
    ...
    {ITEM_KIND_TEXT_SPOT, 0x0000, 0x0154, {0x00, 0x00}, 0x00020000, STAGE_OBJECT_LEVER, 0x0001, 5, {0x00, 0x00}},
    {ITEM_KIND_TEXT_SPOT, 0x0006, 0x0154, {0x00, 0x00}, 0x00004000, STAGE_OBJECT_LEVER, 0x0003, 5, {0x00, 0x00}},
