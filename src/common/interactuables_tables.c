...
interactuables_settings interactuables_settings_table[] = {
    ...
    {ITEM_KIND_TEXT_SPOT, 0x0001, (TEXT_SPOT_DESTROY_IF_EVENT_FLAG_IS_SET), {0x00, 0x00}, EVENT_FLAG_FOREST_AND_DEFAULT_WERETIGER_DOOR_UNLOCKED, 0x0000, 0x0000, 5, {0x00, 0x00}},
    // INTERACT_ID_TEXT_73
