...
#define GPACK_RGBA5551(r, g, b, a)                                             \
    ((((r) << 8) & 0xF800) | (((g) << 3) & 0x07C0) | (((b) >> 2) & 0x003E) |   \
     ((a) & 1))
...
/*
 * ?
#define G_CC_DECALRGBA2             COMBINED, SHADE, COMBINED_ALPHA, SHADE, 0,
0, 0, SHADE
*/
...
#define gdSPDefMtx(xx, xy, xz, xw, yx, yy, yz, yw, zx, zy, zz, zw, wx, wy, wz, \
                   ww)                                                         \
    {                                                                          \
        {                                                                      \
...
#define gdSPDefLights2(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, \
                       z2)                                                     \
    {                                                                          \
        {{                                                                     \
            {ar, ag, ab},                                                      \
...
#define gdSPDefLights3(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, \
                       z2, r3, g3, b3, x3, y3, z3)                             \
    {                                                                          \
        {{                                                                     \
            {ar, ag, ab},                                                      \
            0,                                                                 \
...
#define gdSPDefLights4(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, \
                       z2, r3, g3, b3, x3, y3, z3, r4, g4, b4, x4, y4, z4)     \
    {                                                                          \
        {{                                                                     \
            {ar, ag, ab},                                                      \
            0,                                                                 \
...
#define gdSPDefLights5(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, \
                       z2, r3, g3, b3, x3, y3, z3, r4, g4, b4, x4, y4, z4, r5, \
                       g5, b5, x5, y5, z5)                                     \
    {                                                                          \
        {{                                                                     \
            {ar, ag, ab},                                                      \
...
#define gdSPDefLights6(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, \
                       z2, r3, g3, b3, x3, y3, z3, r4, g4, b4, x4, y4, z4, r5, \
                       g5, b5, x5, y5, z5, r6, g6, b6, x6, y6, z6)             \
    {                                                                          \
        {{                                                                     \
            {ar, ag, ab},                                                      \
            0,                                                                 \
...
#define gdSPDefLights7(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, \
                       z2, r3, g3, b3, x3, y3, z3, r4, g4, b4, x4, y4, z4, r5, \
                       g5, b5, x5, y5, z5, r6, g6, b6, x6, y6, z6, r7, g7, b7, \
                       x7, y7, z7)                                             \
    {                                                                          \
        {{                                                                     \
            {ar, ag, ab},                                                      \
...
typedef struct {
    ...
    unsigned int len : 16;
    union {
        // The exact form of this callback is intentionally left unspecified, a
        // display list parser may choose the return value and parameters so
...
#define gDma1p(pkt, c, s, l, p)                                                \
    _DW({                                                                      \
        Gfx *_g = (Gfx *)(pkt);                                                \
                                                                               \
        _g->words.w0 =                                                         \
            (_SHIFTL((c), 24, 8) | _SHIFTL((p), 16, 8) | _SHIFTL((l), 0, 16)); \
        _g->words.w1 = (unsigned int)(s);                                      \
    })
...
#define gSPVertex(pkt, v, n, v0)                                               \
    _DW({                                                                      \
        Gfx *_g = (Gfx *)(pkt);                                                \
                                                                               \
        _g->words.w0 = (_SHIFTL(G_VTX, 24, 8) | _SHIFTL((n), 12, 8) |          \
                        _SHIFTL((v0) + (n), 1, 7));                            \
...
#define gSPSprite2DBase(pkt, s)                                                \
    gDma1p(pkt, G_SPRITE2D_BASE, s, sizeof(uSprite), 0)
...
#define gsSPSprite2DDraw(px, py)                                               \
    {                                                                          \
        (_SHIFTL(G_SPRITE2D_DRAW, 24, 8)),                                     \
            (_SHIFTL((px), 16, 16) | _SHIFTL((py), 0, 16))                     \
    }
...
#define __gsSP1Triangle_w1(v0, v1, v2)                                         \
    (_SHIFTL((v0) * 2, 16, 8) | _SHIFTL((v1) * 2, 8, 8) |                      \
     _SHIFTL((v2) * 2, 0, 8))
...
/*
 * r should be one of: FRUSTRATIO_1, FRUSTRATIO_2, FRUSTRATIO_3, ...
 * FRUSTRATIO_6
 */
...
#define gsSPModifyVertex(vtx, where, val)                                      \
    {                                                                          \
        (_SHIFTL(G_MODIFYVTX, 24, 8) | _SHIFTL((where), 16, 8) |               \
         _SHIFTL((vtx) * 2, 0, 16)),                                           \
            (unsigned int)(val)                                                \
    }
#else
...
#define gSPBranchLessZrg(pkt, dl, vtx, zval, near, far, flag, zmin, zmax)      \
    _DW({                                                                      \
        ...
        _g = (Gfx *)(pkt);                                                     \
                                                                               \
        _g->words.w0 =                                                         \
            (_SHIFTL(G_BRANCH_Z, 24, 8) | _SHIFTL((vtx) * 5, 12, 12) |         \
             _SHIFTL((vtx) * 2, 0, 12));                                       \
...
#define gsSPLoadUcodeEx(uc_start, uc_dstart, uc_dsize)                         \
    ...
    {                                                                          \
        (_SHIFTL(G_LOAD_UCODE, 24, 8) | _SHIFTL((int)(uc_dsize)-1, 0, 16)),    \
...
#define gSPDmaRead(pkt, dmem, dram, size)                                      \
    gSPDma_io((pkt), 0, (dmem), (dram), (size))
#define gsSPDmaRead(dmem, dram, size) gsSPDma_io(0, (dmem), (dram), (size))
#define gSPDmaWrite(pkt, dmem, dram, size)                                     \
    gSPDma_io((pkt), 1, (dmem), (dram), (size))
...
/* These macros use a structure "name" which is init'd with the gdSPDefLights
 * macros*/
...
#define gsSPSetLights0(name)                                                   \
    gsSPNumLights(NUMLIGHTS_0), gsSPLight(&name.l[0], 1), gsSPLight(&name.a, 2)
...
#define gsSPSetLights1(name)                                                   \
    gsSPNumLights(NUMLIGHTS_1), gsSPLight(&name.l[0], 1), gsSPLight(&name.a, 2)
...
#define gsSPSetLights2(name)                                                   \
    gsSPNumLights(NUMLIGHTS_2), gsSPLight(&name.l[0], 1),                      \
        gsSPLight(&name.l[1], 2), gsSPLight(&name.a, 3)
...
#define gsSPSetLights3(name)                                                   \
    gsSPNumLights(NUMLIGHTS_3), gsSPLight(&name.l[0], 1),                      \
        gsSPLight(&name.l[1], 2), gsSPLight(&name.l[2], 3),                    \
        gsSPLight(&name.a, 4)
...
#define gsSPSetLights4(name)                                                   \
    gsSPNumLights(NUMLIGHTS_4), gsSPLight(&name.l[0], 1),                      \
        gsSPLight(&name.l[1], 2), gsSPLight(&name.l[2], 3),                    \
...
#define gsSPSetLights5(name)                                                   \
    gsSPNumLights(NUMLIGHTS_5), gsSPLight(&name.l[0], 1),                      \
        gsSPLight(&name.l[1], 2), gsSPLight(&name.l[2], 3),                    \
        gsSPLight(&name.l[3], 4), gsSPLight(&name.l[4], 5),                    \
        gsSPLight(&name.a, 6)
...
#define gsSPSetLights6(name)                                                   \
    gsSPNumLights(NUMLIGHTS_6), gsSPLight(&name.l[0], 1),                      \
        gsSPLight(&name.l[1], 2), gsSPLight(&name.l[2], 3),                    \
        gsSPLight(&name.l[3], 4), gsSPLight(&name.l[4], 5),                    \
        gsSPLight(&name.l[5], 6), gsSPLight(&name.a, 7)
...
#define gsSPSetLights7(name)                                                   \
    gsSPNumLights(NUMLIGHTS_7), gsSPLight(&name.l[0], 1),                      \
        gsSPLight(&name.l[1], 2), gsSPLight(&name.l[2], 3),                    \
        gsSPLight(&name.l[3], 4), gsSPLight(&name.l[4], 5),                    \
        gsSPLight(&name.l[5], 6), gsSPLight(&name.l[6], 7),                    \
        gsSPLight(&name.a, 8)
...
#define gsSPFogFactor(fm, fo)                                                  \
    gsMoveWd(G_MW_FOG, G_MWO_FOG, (_SHIFTL(fm, 16, 16) | _SHIFTL(fo, 0, 16)))
...
#define gSPTexture(pkt, s, t, level, tile, on)                                 \
    _DW({                                                                      \
        ...
        _g->words.w0 = (_SHIFTL(G_TEXTURE, 24, 8) |                            \
                        _SHIFTL(BOWTIE_VAL, 16, 8) | _SHIFTL((level), 11, 3) | \
...
#define gSPGeometryMode(pkt, c, s)                                             \
    _DW({                                                                      \
        Gfx *_g = (Gfx *)(pkt);                                                \
                                                                               \
        _g->words.w0 =                                                         \
            (_SHIFTL(G_GEOMETRYMODE, 24, 8) | _SHIFTL(~(u32)(c), 0, 24));      \
        _g->words.w1 = (u32)(s);                                               \
    })
...
#define gSPSetOtherMode(pkt, cmd, sft, len, data)                              \
    _DW({                                                                      \
        Gfx *_g = (Gfx *)(pkt);                                                \
                                                                               \
        _g->words.w0 =                                                         \
            (_SHIFTL(cmd, 24, 8) | _SHIFTL(32 - (sft) - (len), 8, 8) |         \
             _SHIFTL((len)-1, 0, 8));                                          \
...
#define gsSetImage(cmd, fmt, siz, width, i)                                    \
    {                                                                          \
        (_SHIFTL(cmd, 24, 8) | _SHIFTL(fmt, 21, 3) | _SHIFTL(siz, 19, 2) |     \
...
#define GCCc1w1(sbRGB1, saA1, mA1, aRGB1, sbA1, aA1)                           \
    (_SHIFTL((sbRGB1), 24, 4) | _SHIFTL((saA1), 21, 3) |                       \
     _SHIFTL((mA1), 18, 3) | _SHIFTL((aRGB1), 6, 3) | _SHIFTL((sbA1), 3, 3) |  \
     _SHIFTL((aA1), 0, 3))

#define gDPSetCombineLERP(pkt, a0, b0, c0, d0, Aa0, Ab0, Ac0, Ad0, a1, b1, c1, \
                          d1, Aa1, Ab1, Ac1, Ad1)                              \
    _DW({                                                                      \
        Gfx *_g = (Gfx *)(pkt);                                                \
                                                                               \
...
#define gsDPSetCombineLERP(a0, b0, c0, d0, Aa0, Ab0, Ac0, Ad0, a1, b1, c1, d1, \
                           Aa1, Ab1, Ac1, Ad1)                                 \
    {                                                                          \
        (_SHIFTL(G_SETCOMBINE, 24, 8) |                                        \
         _SHIFTL(GCCc0w0(G_CCMUX_##a0, G_CCMUX_##c0, G_ACMUX_##Aa0,            \
            ...
            (unsigned int)(GCCc0w1(G_CCMUX_##b0, G_CCMUX_##d0, G_ACMUX_##Ab0,  \
                                   G_ACMUX_##Ad0) |                            \
                           GCCc1w1(G_CCMUX_##b1, G_ACMUX_##Aa1, G_ACMUX_##Ac1, \
                                   G_CCMUX_##d1, G_ACMUX_##Ab1,                \
                                   G_ACMUX_##Ad1))                             \
    }
...
#define sDPRGBColor(cmd, r, g, b, a)                                           \
    gsDPSetColor(cmd, (_SHIFTL(r, 24, 8) | _SHIFTL(g, 16, 8) |                 \
...
#define gDPSetPrimDepth(pkt, z, dz)                                            \
    gDPSetColor(pkt, G_SETPRIMDEPTH, _SHIFTL(z, 16, 16) | _SHIFTL(dz, 0, 16))

#define gsDPSetPrimDepth(z, dz)                                                \
    gsDPSetColor(G_SETPRIMDEPTH, _SHIFTL(z, 16, 16) | _SHIFTL(dz, 0, 16))
...
#define gsDPLoadTileGeneric(c, tile, uls, ult, lrs, lrt)                       \
    {                                                                          \
        (_SHIFTL(c, 24, 8) | _SHIFTL(uls, 12, 12) | _SHIFTL(ult, 0, 12)),      \
            (_SHIFTL(tile, 24, 3) | _SHIFTL(lrs, 12, 12) |                     \
             _SHIFTL(lrt, 0, 12))                                              \
    }
...
#define gsDPSetTile(fmt, siz, line, tmem, tile, palette, cmt, maskt, shiftt,   \
                    cms, masks, shifts)                                        \
    {                                                                          \
        (_SHIFTL(G_SETTILE, 24, 8) | _SHIFTL(fmt, 21, 3) |                     \
         _SHIFTL(siz, 19, 2) | _SHIFTL(line, 9, 9) | _SHIFTL(tmem, 0, 9)),     \
...
#define gDPLoadTextureBlock(pkt, timg, fmt, siz, width, height, pal, cms, cmt, \
                            masks, maskt, shifts, shiftt)                      \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);               \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt,    \
...
#define gDPLoadTextureBlockYuv(pkt, timg, fmt, siz, width, height, pal, cms,   \
    ...
    _DW({                                                                      \
        ...
        gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0,                                 \
                     ...
                     CALC_DXT(width, siz##_BYTES));                            \
        gDPPipeSync(pkt);                                                      \
        gDPSetTile(pkt, fmt, siz, (((width) * 1) + 7) >> 3, 0,                 \
                   G_TX_RENDERTILE, pal, cmt, maskt, shiftt, cms, masks,       \
                   shifts);                                                    \
        gDPSetTileSize(pkt, G_TX_RENDERTILE, 0, 0,                             \
                       ((width)-1) << G_TEXTURE_IMAGE_FRAC,                    \
...
#define gDPLoadTextureBlockS(pkt, timg, fmt, siz, width, height, pal, cms,     \
                             cmt, masks, maskt, shifts, shiftt)                \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);               \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt,    \
...
#define gDPLoadMultiBlockS(pkt, timg, tmem, rtile, fmt, siz, width, height,    \
    ...
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);               \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt, \
                   maskt, shiftt, cms, masks, shifts);                         \
        gDPLoadSync(pkt);                                                      \
        gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0,                                 \
                     (((width) * (height) + siz##_INCR) >> siz##_SHIFT) - 1,   \
...
#define gDPLoadTextureBlockYuvS(pkt, timg, fmt, siz, width, height, pal, cms,  \
                                cmt, masks, maskt, shifts, shiftt)             \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);               \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt,    \
...
#define _gDPLoadTextureBlock(pkt, timg, tmem, fmt, siz, width, height, pal,    \
    ...
    _DW({                                                                      \
        ...
        gDPPipeSync(pkt);                                                      \
        gDPSetTile(pkt, fmt, siz, (((width) * siz##_LINE_BYTES) + 7) >> 3,     \
                   tmem, G_TX_RENDERTILE, pal, cmt, maskt, shiftt, cms, masks, \
                   shifts);                                                    \
        gDPSetTileSize(pkt, G_TX_RENDERTILE, 0, 0,                             \
                       ((width)-1) << G_TEXTURE_IMAGE_FRAC,                    \
                       ((height)-1) << G_TEXTURE_IMAGE_FRAC);                  \
...
#define _gDPLoadTextureBlockTile(pkt, timg, tmem, rtile, fmt, siz, width,      \
                                 height, pal, cms, cmt, masks, maskt, shifts,  \
                                 shiftt)                                       \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);               \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt, \
 ...
 *  allows tmem address and render tile to be specified
 */
#define gDPLoadMultiBlock(pkt, timg, tmem, rtile, fmt, siz, width, height,     \
                          pal, cms, cmt, masks, maskt, shifts, shiftt)         \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, siz##_LOAD_BLOCK, 1, timg);               \
        gDPSetTile(pkt, fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt, \
...
#define gsDPLoadTextureBlock(timg, fmt, siz, width, height, pal, cms, cmt,     \
                             masks, maskt, shifts, shiftt)                     \
    gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                       \
        gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, \
                    shiftt, cms, masks, shifts),                               \
        gsDPLoadSync(),                                                        \
...
#define gsDPLoadTextureBlockS(timg, fmt, siz, width, height, pal, cms, cmt,    \
                              masks, maskt, shifts, shiftt)                    \
    gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                       \
        gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, \
                    shiftt, cms, masks, shifts),                               \
 ...
 */
#define _gsDPLoadTextureBlock(timg, tmem, fmt, siz, width, height, pal, cms,   \
                              cmt, masks, maskt, shifts, shiftt)               \
    gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                       \
        gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt,     \
                    maskt, shiftt, cms, masks, shifts),                        \
        gsDPLoadSync(),                                                        \
        gsDPLoadBlock(G_TX_LOADTILE, 0, 0,                                     \
                      (((width) * (height) + siz##_INCR) >> siz##_SHIFT) - 1,  \
 ...
 */
#define _gsDPLoadTextureBlockTile(timg, tmem, rtile, fmt, siz, width, height,  \
                                  pal, cms, cmt, masks, maskt, shifts, shiftt) \
    gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                       \
        gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt,     \
                    maskt, shiftt, cms, masks, shifts),                        \
        ...
        gsDPSetTileSize(rtile, 0, 0, ((width)-1) << G_TEXTURE_IMAGE_FRAC,      \
                        ((height)-1) << G_TEXTURE_IMAGE_FRAC)
...
#define gDPLoadTextureBlock_4b(pkt, timg, fmt, width, height, pal, cms, cmt,   \
                               masks, maskt, shifts, shiftt)                   \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_16b, 1, timg);                   \
        gDPSetTile(pkt, fmt, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, \
                   shiftt, cms, masks, shifts);                                \
        gDPLoadSync(pkt);                                                      \
        gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0,                                 \
                     (((width) * (height) + 3) >> 2) - 1, CALC_DXT_4b(width)); \
        gDPPipeSync(pkt);                                                      \
...
#define gDPLoadTextureBlock_4bS(pkt, timg, fmt, width, height, pal, cms, cmt,  \
                                masks, maskt, shifts, shiftt)                  \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_16b, 1, timg);                   \
        gDPSetTile(pkt, fmt, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, cmt, maskt, \
...
#define gDPLoadMultiBlock_4b(pkt, timg, tmem, rtile, fmt, width, height, pal,  \
    ...
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_16b, 1, timg);                   \
        gDPSetTile(pkt, fmt, G_IM_SIZ_16b, 0, tmem, G_TX_LOADTILE, 0, cmt,     \
                   maskt, shiftt, cms, masks, shifts);                         \
        gDPLoadSync(pkt);                                                      \
        gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0,                                 \
                     (((width) * (height) + 3) >> 2) - 1, CALC_DXT_4b(width)); \
...
#define _gDPLoadTextureBlock_4b(pkt, timg, tmem, fmt, width, height, pal, cms, \
                                cmt, masks, maskt, shifts, shiftt)             \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_16b, 1, timg);                   \
        gDPSetTile(pkt, fmt, G_IM_SIZ_16b, 0, tmem, G_TX_LOADTILE, 0, cmt,     \
...
#define gsDPLoadTextureBlock_4b(timg, fmt, width, height, pal, cms, cmt,       \
                                masks, maskt, shifts, shiftt)                  \
    gsDPSetTextureImage(fmt, G_IM_SIZ_16b, 1, timg),                           \
        gsDPSetTile(fmt, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, cmt, maskt,     \
                    shiftt, cms, masks, shifts),                               \
        gsDPLoadSync(),                                                        \
        gsDPLoadBlock(G_TX_LOADTILE, 0, 0,                                     \
                      (((width) * (height) + 3) >> 2) - 1,                     \
...
#define gsDPLoadTextureBlock_4bS(timg, fmt, width, height, pal, cms, cmt,      \
                                 masks, maskt, shifts, shiftt)                 \
    gsDPSetTextureImage(fmt, G_IM_SIZ_16b, 1, timg),                           \
        gsDPSetTile(fmt, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, cmt, maskt,     \
                    shiftt, cms, masks, shifts),                               \
 ...
 */
#define gsDPLoadMultiBlock_4b(timg, tmem, rtile, fmt, width, height, pal, cms, \
                              cmt, masks, maskt, shifts, shiftt)               \
    gsDPSetTextureImage(fmt, G_IM_SIZ_16b, 1, timg),                           \
        gsDPSetTile(fmt, G_IM_SIZ_16b, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt,  \
                    shiftt, cms, masks, shifts),                               \
        gsDPLoadSync(),                                                        \
        gsDPLoadBlock(G_TX_LOADTILE, 0, 0,                                     \
                      (((width) * (height) + 3) >> 2) - 1,                     \
 ...
 *  Allows tmem address to be specified
 */
#define _gsDPLoadTextureBlock_4b(timg, tmem, fmt, width, height, pal, cms,     \
                                 cmt, masks, maskt, shifts, shiftt)            \
    gsDPSetTextureImage(fmt, G_IM_SIZ_16b, 1, timg),                           \
        gsDPSetTile(fmt, G_IM_SIZ_16b, 0, tmem, G_TX_LOADTILE, 0, cmt, maskt,  \
                    shiftt, cms, masks, shifts),                               \
...
#define gDPLoadTextureTile(pkt, timg, fmt, siz, width, height, uls, ult, lrs,  \
                           lrt, pal, cms, cmt, masks, maskt, shifts, shiftt)   \
    _DW({                                                                      \
        ...
        gDPLoadSync(pkt);                                                      \
        gDPLoadTile(pkt, G_TX_LOADTILE, (uls) << G_TEXTURE_IMAGE_FRAC,         \
        ...
        gDPSetTile(pkt, fmt, siz,                                              \
                   ...
                   G_TX_RENDERTILE, pal, cmt, maskt, shiftt, cms, masks,       \
                   shifts);                                                    \
        gDPSetTileSize(pkt, G_TX_RENDERTILE, (uls) << G_TEXTURE_IMAGE_FRAC,    \
                       (ult) << G_TEXTURE_IMAGE_FRAC,                          \
                       (lrs) << G_TEXTURE_IMAGE_FRAC,                          \
                       (lrt) << G_TEXTURE_IMAGE_FRAC);                         \
    })
...
#define gDPLoadTextureTile(pkt, timg, fmt, siz, width, height, uls, ult, lrs,  \
    ...
    _DW({                                                                      \
        ...
        guDPLoadTextureTile(_loadtile_temp, timg, fmt, siz, width, height,     \
                            uls, ult, lrs, lrt, pal, cms, cmt, masks, maskt,   \
                            shifts, shiftt);                                   \
 ...
 */
#define gDPLoadMultiTile(pkt, timg, tmem, rtile, fmt, siz, width, height, uls, \
                         ult, lrs, lrt, pal, cms, cmt, masks, maskt, shifts,   \
                         shiftt)                                               \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, siz, width, timg);                        \
        gDPSetTile(pkt, fmt, siz,                                              \
                   (((((lrs) - (uls) + 1) * siz##_TILE_BYTES) + 7) >> 3),      \
                   tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,     \
                   shifts);                                                    \
        gDPLoadSync(pkt);                                                      \
        gDPLoadTile(pkt, G_TX_LOADTILE, (uls) << G_TEXTURE_IMAGE_FRAC,         \
                    (ult) << G_TEXTURE_IMAGE_FRAC,                             \
        ...
        gDPSetTile(pkt, fmt, siz,                                              \
                   ...
                   tmem, rtile, pal, cmt, maskt, shiftt, cms, masks, shifts);  \
        gDPSetTileSize(pkt, rtile, (uls) << G_TEXTURE_IMAGE_FRAC,              \
                       (ult) << G_TEXTURE_IMAGE_FRAC,                          \
                       (lrs) << G_TEXTURE_IMAGE_FRAC,                          \
                       (lrt) << G_TEXTURE_IMAGE_FRAC);                         \
    })

#define gsDPLoadTextureTile(timg, fmt, siz, width, height, uls, ult, lrs, lrt, \
                            pal, cms, cmt, masks, maskt, shifts, shiftt)       \
    gsDPSetTextureImage(fmt, siz, width, timg),                                \
        gsDPSetTile(fmt, siz,                                                  \
                    ...
                    G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, shifts), \
        gsDPLoadSync(),                                                        \
        gsDPLoadTile(G_TX_LOADTILE, (uls) << G_TEXTURE_IMAGE_FRAC,             \
                     (ult) << G_TEXTURE_IMAGE_FRAC,                            \
                     (lrs) << G_TEXTURE_IMAGE_FRAC,                            \
                     (lrt) << G_TEXTURE_IMAGE_FRAC),                           \
        gsDPPipeSync(),                                                        \
        gsDPSetTile(                                                           \
            fmt, siz, (((((lrs) - (uls) + 1) * siz##_LINE_BYTES) + 7) >> 3),   \
            0, G_TX_RENDERTILE, pal, cmt, maskt, shiftt, cms, masks, shifts),  \
        gsDPSetTileSize(G_TX_RENDERTILE, (uls) << G_TEXTURE_IMAGE_FRAC,        \
                        (ult) << G_TEXTURE_IMAGE_FRAC,                         \
                        (lrs) << G_TEXTURE_IMAGE_FRAC,                         \
                        (lrt) << G_TEXTURE_IMAGE_FRAC)
 ...
 *  Useful for loading multiple tiles.
 */
#define gsDPLoadMultiTile(timg, tmem, rtile, fmt, siz, width, height, uls,     \
                          ult, lrs, lrt, pal, cms, cmt, masks, maskt, shifts,  \
                          shiftt)                                              \
    gsDPSetTextureImage(fmt, siz, width, timg),                                \
        gsDPSetTile(                                                           \
            fmt, siz, (((((lrs) - (uls) + 1) * siz##_TILE_BYTES) + 7) >> 3),   \
            tmem, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, shifts),   \
        gsDPLoadSync(),                                                        \
        gsDPLoadTile(G_TX_LOADTILE, (uls) << G_TEXTURE_IMAGE_FRAC,             \
                     (ult) << G_TEXTURE_IMAGE_FRAC,                            \
                     (lrs) << G_TEXTURE_IMAGE_FRAC,                            \
        ...
        gsDPSetTile(fmt, siz,                                                  \
                    (((((lrs) - (uls) + 1) * siz##_LINE_BYTES) + 7) >> 3),     \
                    tmem, rtile, pal, cmt, maskt, shiftt, cms, masks, shifts), \
        gsDPSetTileSize(rtile, (uls) << G_TEXTURE_IMAGE_FRAC,                  \
                        (ult) << G_TEXTURE_IMAGE_FRAC,                         \
                        (lrs) << G_TEXTURE_IMAGE_FRAC,                         \
                        (lrt) << G_TEXTURE_IMAGE_FRAC)

#define gDPLoadTextureTile_4b(pkt, timg, fmt, width, height, uls, ult, lrs,    \
                              lrt, pal, cms, cmt, masks, maskt, shifts,        \
                              shiftt)                                          \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_8b, ((width) >> 1), timg);       \
        gDPSetTile(pkt, fmt, G_IM_SIZ_8b,                                      \
                   (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), 0, G_TX_LOADTILE,  \
                   0, cmt, maskt, shiftt, cms, masks, shifts);                 \
        gDPLoadSync(pkt);                                                      \
        gDPLoadTile(pkt, G_TX_LOADTILE, (uls) << (G_TEXTURE_IMAGE_FRAC - 1),   \
                    (ult) << (G_TEXTURE_IMAGE_FRAC),                           \
                    (lrs) << (G_TEXTURE_IMAGE_FRAC - 1),                       \
                    (lrt) << (G_TEXTURE_IMAGE_FRAC));                          \
        gDPPipeSync(pkt);                                                      \
        gDPSetTile(                                                            \
            pkt, fmt, G_IM_SIZ_4b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), 0, \
 ...
 *  Useful for loading multiple tiles.
 */
#define gDPLoadMultiTile_4b(pkt, timg, tmem, rtile, fmt, width, height, uls,   \
                            ult, lrs, lrt, pal, cms, cmt, masks, maskt,        \
                            shifts, shiftt)                                    \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, fmt, G_IM_SIZ_8b, ((width) >> 1), timg);       \
        gDPSetTile(pkt, fmt, G_IM_SIZ_8b,                                      \
        ...
        gDPSetTile(pkt, fmt, G_IM_SIZ_4b,                                      \
                   (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), tmem, rtile, pal,  \
...
#define gsDPLoadTextureTile_4b(timg, fmt, width, height, uls, ult, lrs, lrt,   \
                               pal, cms, cmt, masks, maskt, shifts, shiftt)    \
    gsDPSetTextureImage(fmt, G_IM_SIZ_8b, ((width) >> 1), timg),               \
        gsDPSetTile(fmt, G_IM_SIZ_8b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), \
                    0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks,       \
                    shifts),                                                   \
        gsDPLoadSync(),                                                        \
        gsDPLoadTile(G_TX_LOADTILE, (uls) << (G_TEXTURE_IMAGE_FRAC - 1),       \
                     (ult) << (G_TEXTURE_IMAGE_FRAC),                          \
                     (lrs) << (G_TEXTURE_IMAGE_FRAC - 1),                      \
                     (lrt) << (G_TEXTURE_IMAGE_FRAC)),                         \
        gsDPPipeSync(),                                                        \
        gsDPSetTile(fmt, G_IM_SIZ_4b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), \
                    0, G_TX_RENDERTILE, pal, cmt, maskt, shiftt, cms, masks,   \
                    shifts),                                                   \
        gsDPSetTileSize(G_TX_RENDERTILE, (uls) << G_TEXTURE_IMAGE_FRAC,        \
                        (ult) << G_TEXTURE_IMAGE_FRAC,                         \
                        (lrs) << G_TEXTURE_IMAGE_FRAC,                         \
 ...
 *  Useful for loading multiple tiles.
 */
#define gsDPLoadMultiTile_4b(timg, tmem, rtile, fmt, width, height, uls, ult,  \
                             lrs, lrt, pal, cms, cmt, masks, maskt, shifts,    \
                             shiftt)                                           \
                                                                               \
    gsDPSetTextureImage(fmt, G_IM_SIZ_8b, ((width) >> 1), timg),               \
        gsDPSetTile(fmt, G_IM_SIZ_8b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), \
...
#define gDPLoadTLUT_pal16(pkt, pal, dram)                                      \
    _gDPLoadTextureBlock(pkt, dram, (256 + (((pal) & 0xF) * 16)),              \
                         G_IM_FMT_RGBA, G_IM_SIZ_16b, 4 * 16, 1, pal, 0, 0, 0, \
                         0, 0, 0)
...
#define gsDPLoadTLUT_pal16(pal, dram)                                          \
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dram), gsDPTileSync(), \
        gsDPSetTile(0, 0, 0, (256 + (((pal) & 0xF) * 16)), G_TX_LOADTILE, 0,   \
                    0, 0, 0, 0, 0, 0),                                         \
        gsDPLoadSync(), gsDPLoadTLUTCmd(G_TX_LOADTILE, 15), gsDPPipeSync()

#else /* **** WORKAROUND hardware 1 load_tlut bug ****** */

#define gsDPLoadTLUT_pal16(pal, dram)                                          \
    _gsDPLoadTextureBlock(dram, (256 + (((pal) & 0xF) * 16)), G_IM_FMT_RGBA,   \
                          G_IM_SIZ_16b, 4 * 16, 1, pal, 0, 0, 0, 0, 0, 0)
...
#define gDPLoadTLUT_pal256(pkt, dram)                                          \
    _gDPLoadTextureBlock(pkt, dram, 256, G_IM_FMT_RGBA, G_IM_SIZ_16b, 4 * 256, \
                         1, 0, 0, 0, 0, 0, 0, 0)
...
#define gsDPLoadTLUT_pal256(dram)                                              \
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dram), gsDPTileSync(), \
        ...
        gsDPLoadSync(), gsDPLoadTLUTCmd(G_TX_LOADTILE, 255), gsDPPipeSync()

#else /* **** WORKAROUND hardware 1 load_tlut bug ****** */

#define gsDPLoadTLUT_pal256(dram)                                              \
    _gsDPLoadTextureBlock(dram, 256, G_IM_FMT_RGBA, G_IM_SIZ_16b, 4 * 256, 1,  \
                          0, 0, 0, 0, 0, 0, 0)
...
#define gDPLoadTLUT(pkt, count, tmemaddr, dram)                                \
    _DW({                                                                      \
        gDPSetTextureImage(pkt, G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dram);         \
        gDPTileSync(pkt);                                                      \
        gDPSetTile(pkt, 0, 0, 0, tmemaddr, G_TX_LOADTILE, 0, 0, 0, 0, 0, 0,    \
                   0);                                                         \
        gDPLoadSync(pkt);                                                      \
...
#define gDPLoadTLUT(pkt, count, tmemaddr, dram)                                \
    _gDPLoadTextureBlock(pkt, dram, tmemaddr, G_IM_FMT_RGBA, G_IM_SIZ_16b, 4,  \
                         count, 0, 0, 0, 0, 0, 0, 0)
...
#define gsDPLoadTLUT(count, tmemaddr, dram)                                    \
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dram), gsDPTileSync(), \
        ...
        gsDPLoadSync(), gsDPLoadTLUTCmd(G_TX_LOADTILE, ((count)-1)),           \
        gsDPPipeSync()

#else /* **** WORKAROUND hardware 1 load_tlut bug ****** */

#define gsDPLoadTLUT(count, tmemaddr, dram)                                    \
    _gsDPLoadTextureBlock(dram, tmemaddr, G_IM_FMT_RGBA, G_IM_SIZ_16b, 4,      \
                          count, 0, 0, 0, 0, 0, 0, 0)
...
#define gDPSetScissorFrac(pkt, mode, ulx, uly, lrx, lry)                       \
    _DW({                                                                      \
        Gfx *_g = (Gfx *)pkt;                                                  \
                                                                               \
        _g->words.w0 =                                                         \
            (_SHIFTL(G_SETSCISSOR, 24, 8) | _SHIFTL((int)((ulx)), 12, 12) |    \
             _SHIFTL((int)((uly)), 0, 12));                                    \
        _g->words.w1 = (_SHIFTL(mode, 24, 2) | _SHIFTL((int)((lrx)), 12, 12) | \
...
#define gsDPSetScissorFrac(mode, ulx, uly, lrx, lry)                           \
    {                                                                          \
        (_SHIFTL(G_SETSCISSOR, 24, 8) | _SHIFTL((int)((ulx)), 12, 12) |        \
         _SHIFTL((int)((uly)), 0, 12)),                                        \
            (_SHIFTL(mode, 24, 2) | _SHIFTL((int)(lrx), 12, 12) |              \
             _SHIFTL((int)(lry), 0, 12))                                       \
    }
...
#define gDPScisFillRectangle(pkt, ulx, uly, lrx, lry)                          \
    _DW({                                                                      \
        Gfx *_g = (Gfx *)(pkt);                                                \
                                                                               \
        _g->words.w0 =                                                         \
            (_SHIFTL(G_FILLRECT, 24, 8) | _SHIFTL(MAX((lrx), 0), 14, 10) |     \
             _SHIFTL(MAX((lry), 0), 2, 10));                                   \
        _g->words.w1 =                                                         \
            (_SHIFTL(MAX((ulx), 0), 14, 10) | _SHIFTL(MAX((uly), 0), 2, 10));  \
    })
...
#define gDPSetConvert(pkt, k0, k1, k2, k3, k4, k5)                             \
    _DW({                                                                      \
        Gfx *_g = (Gfx *)(pkt);                                                \
                                                                               \
        _g->words.w0 = (_SHIFTL(G_SETCONVERT, 24, 8) | _SHIFTL(k0, 13, 9) |    \
                        _SHIFTL(k1, 4, 9) | _SHIFTR(k2, 5, 4));                \
...
#define gsDPSetConvert(k0, k1, k2, k3, k4, k5)                                 \
    {                                                                          \
        (_SHIFTL(G_SETCONVERT, 24, 8) | _SHIFTL(k0, 13, 9) |                   \
         _SHIFTL(k1, 4, 9) | _SHIFTL(k2, 5, 4)),                               \
...
#define gDPSetKeyGB(pkt, cG, sG, wG, cB, sB, wB)                               \
    _DW({                                                                      \
        Gfx *_g = (Gfx *)(pkt);                                                \
                                                                               \
        _g->words.w0 = (_SHIFTL(G_SETKEYGB, 24, 8) | _SHIFTL(wG, 12, 12) |     \
                        _SHIFTL(wB, 0, 12));                                   \
...
#define gSPScisTextureRectangle(pkt, xl, yl, xh, yh, tile, s, t, dsdx, dtdy)   \
    _DW({                                                                      \
        Gfx *_g = (Gfx *)(pkt);                                                \
                                                                               \
        _g->words.w0 =                                                         \
            (_SHIFTL(G_TEXRECT, 24, 8) | _SHIFTL(MAX((s16)(xh), 0), 12, 12) |  \
             _SHIFTL(MAX((s16)(yh), 0), 0, 12));                               \
        _g->words.w1 =                                                         \
            (_SHIFTL((tile), 24, 3) | _SHIFTL(MAX((s16)(xl), 0), 12, 12) |     \
...
#define gDPNoOpCallBack(pkt, callback, arg)                                    \
    gDma1p(pkt, G_NOOP, callback, arg, 6)
