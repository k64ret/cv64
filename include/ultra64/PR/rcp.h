...
/* SP read DMA length (R/W): [11:0] length, [19:12] count, [31:20] skip; RDRAM
 * -> I/DMEM */
#define SP_RD_LEN_REG (SP_BASE_REG + 0x08)

/* SP write DMA length (R/W): [11:0] length, [19:12] count, [31:20] skip; I/DMEM
 * -> RDRAM */
...
#define RCP_STAT_PRINT                                                         \
    rmonPrintf("current=%x start=%x end=%x dpstat=%x spstat=%x\n",             \
               ...
               IO_READ(DPC_END_REG), IO_READ(DPC_STATUS_REG),                  \
