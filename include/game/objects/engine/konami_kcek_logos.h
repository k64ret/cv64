...
void cv64_ovl_konamilogo_check_btn_press(
    cv64_ovl_konamilogo_t* self);                               // 0x801cfd40
...
void cv64_ovl_konamilogo_kcek_fade_in(
    cv64_ovl_konamilogo_t* self);                                // 0x801cffdc
void cv64_ovl_konamilogo_kcek_wait(cv64_ovl_konamilogo_t* self); // 0x801d0058
void cv64_ovl_konamilogo_kcek_fade_out(
    cv64_ovl_konamilogo_t* self); // 0x801d00e0
