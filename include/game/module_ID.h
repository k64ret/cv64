...
enum module_flags {
    NO_FLAG = 0x00,
    STAGE_OBJECT =
        0x10, // Non-enemy map actors. Sometimes 0x18 is used as well.
    MAP_OVERLAY = 0x20,
    DESTROY     = 0x80
};
...
enum module_ID {
    ...
    CUTSCENE_CUTSCENE_FOREST_BLESSING =
        MODULE_ID(MAP_OVERLAY, ID_CUTSCENE_FOREST_BLESSING),
    ...
    PLAYER_REINHARDT_DYNAMIC_SCARF =
        MODULE_ID(NO_FLAG, ID_REINHARDT_DYNAMIC_SCARF),
    ...
    PLAYER_CARRIE_DYNAMIC_RIGHT_STRIP =
        MODULE_ID(NO_FLAG, ID_CARRIE_DYNAMIC_RIGHT_STRIP),
    PLAYER_CARRIE_DYNAMIC_LEFT_STRIP =
        MODULE_ID(NO_FLAG, ID_CARRIE_DYNAMIC_LEFT_STRIP),
