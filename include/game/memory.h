...
typedef enum cv64_heapblock_flag {
    ...
    HEAP_BLOCK_4000 =
        0x4000, // Display List / GFX related? See `func_80001008_1C08`
...
typedef struct cv64_heapblock_hdr {
    ...
    void* data_ptrs[2]; // data_ptrs[0] = Start ptr, data_ptrs[1] = End ptr (End
                        // of the allocated data, NOT end of the block)
