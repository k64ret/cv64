...
typedef enum cv64_object_id {
    ...
    // Cutscene
    CUTSCENE_MANDRAGORA_TEXTBOX                  = CV64_OBJECT_ID(OBJ_KIND_MAP_OVERLAY, ID_MANDRAGORA_TEXTBOX),
    CUTSCENE_NITRO_TEXTBOX                       = CV64_OBJECT_ID(OBJ_KIND_MAP_OVERLAY, ID_NITRO_TEXTBOX),
    CUTSCENE_NITRO_DISPOSAL_TEXTBOX              = CV64_OBJECT_ID(OBJ_KIND_MAP_OVERLAY, ID_NITRO_DISPOSAL_TEXTBOX),
    CUTSCENE_EXPLOSIVE_WALL_SPOT                 = CV64_OBJECT_ID(OBJ_KIND_MAP_OVERLAY, ID_EXPLOSIVE_WALL_SPOT),
    CUTSCENE_BOTTOM_ELEVATOR_ACTIVATOR_TEXTBOX   = CV64_OBJECT_ID(OBJ_KIND_MAP_OVERLAY, ID_BOTTOM_ELEVATOR_ACTIVATOR_TEXTBOX),
    CUTSCENE_LIBRARY_PUZZLE                      = CV64_OBJECT_ID(OBJ_KIND_MAP_OVERLAY, ID_LIBRARY_PUZZLE),
    CUTSCENE_INTERACTABLES                       = CV64_OBJECT_ID(OBJ_KIND_NONE, ID_INTERACTABLES),
    ...
    CUTSCENE_CS_FILM_REEL                        = CV64_OBJECT_ID(OBJ_KIND_MAP_OVERLAY, ID_CS_FILM_REEL),
    CUTSCENE_CUTSCENE_FOREST_INTRO               = CV64_OBJECT_ID(OBJ_KIND_MAP_OVERLAY, ID_CUTSCENE_FOREST_INTRO),
    ...
    PLAYER_ENEMY_TARGET_GFX                      = CV64_OBJECT_ID(OBJ_KIND_NONE, ID_ENEMY_TARGET_GFX),
    ...
    STAGE_OBJECT_HONMARU_4F_MINAMI_LIBRARY_PIECE = CV64_OBJECT_ID(OBJ_KIND_NONE, ID_HONMARU_4F_MINAMI_LIBRARY_PIECE),
