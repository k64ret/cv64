...
typedef enum cv64_object_id {
    ...
    CUTSCENE_NITRO_TEXTBOX             = CV64_OBJECT_ID(OBJ_KIND_NONE, ID_NITRO_TEXTBOX),
    CUTSCENE_NITRO_DISPOSAL_TEXTBOX    = CV64_OBJECT_ID(OBJ_KIND_NONE, ID_NITRO_DISPOSAL_TEXTBOX),
    CUTSCENE_BOTTOM_ELEVATOR_ACTIVATOR_TEXTBOX    = CV64_OBJECT_ID(OBJ_KIND_NONE, ID_BOTTOM_ELEVATOR_ACTIVATOR_TEXTBOX),
