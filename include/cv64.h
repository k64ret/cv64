...
#define NI_OVERLAY_CERBERUS                    0x72
#define NI_OVERLAY_WHITE_DRAGON                0x73
#define NI_OVERLAY_GARDENER                    0x74
#define NI_OVERLAY_STONE_DOG                   0x75
#define NI_OVERLAY_MALUS                       0x76
#define NI_OVERLAY_BEHEMOTH                    0x77
#define NI_OVERLAY_WERETIGER                   0x78
#define NI_OVERLAY_WEREWOLF                    0x79
#define NI_OVERLAY_HELL_KNIGHT                 0x7A
#define NI_OVERLAY_GHOST                       0x7B
#define NI_OVERLAY_ICEMAN                      0x7C
#define NI_OVERLAY_ICEMAN_ASSETS_LOADER        0x7D
#define NI_OVERLAY_7E                          0x7E
#define NI_OVERLAY_FLYING_SKULL                0x7F
#define NI_OVERLAY_BAT                         0x80
#define NI_OVERLAY_MEDUSA_HEAD                 0x81
#define NI_OVERLAY_PILLAR_OF_BONES             0x82
#define NI_OVERLAY_VAMPIRES                    0x83
#define NI_OVERLAY_VINCENT                     0x84
#define NI_OVERLAY_85                          0x85
#define NI_OVERLAY_86                          0x86
#define NI_OVERLAY_87                          0x87
#define NI_OVERLAY_88                          0x88
#define NI_OVERLAY_89                          0x89
#define NI_OVERLAY_SPIDER_CENTAUR              0x8A
#define NI_OVERLAY_LIZARD_MAN                  0x8B
#define NI_OVERLAY_SKELETON_WARRIOR            0x8C
#define NI_OVERLAY_KING_SKELETON               0x8D
#define NI_OVERLAY_SKELETON_BIKER              0x8E
#define NI_OVERLAY_TRUE_DRACULA                0x8F
#define NI_OVERLAY_90                          0x90
#define NI_OVERLAY_91                          0x91
#define NI_OVERLAY_MALUS_CUTSCENE              0x92
#define NI_OVERLAY_MALUS_HORSE                 0x93
#define NI_OVERLAY_DEMON_DRACULA               0x94
#define NI_OVERLAY_DEMON_DRACULA_ASSETS_LOADER 0x95
#define NI_OVERLAY_96                          0x96
#define NI_OVERLAY_97                          0x97
#define NI_OVERLAY_VAMPIRE_GILDRE              0x98
#define NI_OVERLAY_99                          0x99
#define NI_OVERLAY_RENON_DEMON                 0x9A
#define NI_OVERLAY_DEATH                       0x9B
#define NI_OVERLAY_9C                          0x9C
#define NI_OVERLAY_ROSA                        0x9D
#define NI_OVERLAY_CAMILLA                     0x9E
#define NI_OVERLAY_ACTRISE                     0x9F
#define NI_OVERLAY_A0                          0xA0
#define NI_OVERLAY_A1                          0xA1
#define NI_OVERLAY_A2                          0xA2
#define NI_OVERLAY_A3                          0xA3
#define NI_OVERLAY_A4                          0xA4
#define NI_OVERLAY_HELL_KNIGHT_STATIC          0xA5
#define NI_OVERLAY_A6                          0xA6
#define NI_OVERLAY_SCROLL                      0xA7
#define NI_OVERLAY_A8                          0xA8
#define NI_OVERLAY_GAMENOTE_DELETE_MGR         0xA9
#define NI_OVERLAY_TITLE_SCREEN                0xAA
#define NI_OVERLAY_AB                          0xAB
#define NI_OVERLAY_AC                          0xAC
#define NI_OVERLAY_TITLE_DEMO                  0xAD
#define NI_OVERLAY_CREDITSMGR                  0xAE
#define NI_OVERLAY_PAUSE_MENU                  0xAF
#define NI_OVERLAY_CHARACTER_SELECT            0xB0
#define NI_OVERLAY_GAME_OVER                   0xB1
#define NI_OVERLAY_SAVE_GAME_RESULTS           0xB2
#define NI_OVERLAY_B3                          0xB3
#define NI_OVERLAY_SAVE_GAME                   0xB4
#define NI_OVERLAY_TEXTBOX_ADVANCE_ARROW       0xB5
#define NI_OVERLAY_BUTTON_CONFIG_OPTION_MENU   0xB6
#define NI_OVERLAY_ENTRANCE_MAP_NAME_DISPLAY   0xB7
#define NI_OVERLAY_CONTRACTMGR                 0xB8
#define NI_OVERLAY_RENONS_BRIEFCASE            0xB9
#define NI_OVERLAY_BA                          0xBA
#define NI_OVERLAY_EASY_MODE_ENDING_MSG        0xBB
#define NI_OVERLAY_BC                          0xBC
#define NI_OVERLAY_NITRO_MANDRAGORA_DISPLAY    0xBD
#define NI_OVERLAY_BE                          0xBE
#define NI_OVERLAY_BF                          0xBF
#define NI_OVERLAY_C0                          0xC0
#define NI_OVERLAY_C1                          0xC1
#define NI_OVERLAY_C2                          0xC2
#define NI_OVERLAY_FILM_REEL_CUTSCENE_EFFECT   0xC3
#define NI_OVERLAY_CUTSCENE_01                 0xC4
#define NI_OVERLAY_CUTSCENE_03                 0xC5
#define NI_OVERLAY_CUTSCENE_04                 0xC6
#define NI_OVERLAY_CUTSCENE_05                 0xC7
#define NI_OVERLAY_CUTSCENE_06                 0xC8
#define NI_OVERLAY_CUTSCENE_07                 0xC9
#define NI_OVERLAY_CUTSCENE_08                 0xCA
#define NI_OVERLAY_CUTSCENE_09                 0xCB
#define NI_OVERLAY_CUTSCENE_0A                 0xCC
#define NI_OVERLAY_CUTSCENE_0B                 0xCD
#define NI_OVERLAY_CUTSCENE_0C                 0xCE
#define NI_OVERLAY_CUTSCENE_0D                 0xCF
#define NI_OVERLAY_CUTSCENE_0E                 0xD0
#define NI_OVERLAY_CUTSCENE_0F                 0xD1
#define NI_OVERLAY_CUTSCENE_10                 0xD2
#define NI_OVERLAY_CUTSCENE_11                 0xD3
#define NI_OVERLAY_CUTSCENE_12                 0xD4
#define NI_OVERLAY_CUTSCENE_13                 0xD5
#define NI_OVERLAY_CUTSCENE_14                 0xD6
#define NI_OVERLAY_CUTSCENE_15                 0xD7
#define NI_OVERLAY_CUTSCENE_16                 0xD8
#define NI_OVERLAY_CUTSCENE_17                 0xD9
#define NI_OVERLAY_CUTSCENE_18                 0xDA
#define NI_OVERLAY_CUTSCENE_19                 0xDB
#define NI_OVERLAY_CUTSCENE_1A                 0xDC
#define NI_OVERLAY_CUTSCENE_1B                 0xDD
#define NI_OVERLAY_CUTSCENE_1C                 0xDE
#define NI_OVERLAY_CUTSCENE_1E                 0xDF
#define NI_OVERLAY_CUTSCENE_1F                 0xE0
#define NI_OVERLAY_CUTSCENE_21                 0xE1
#define NI_OVERLAY_CUTSCENE_22                 0xE2
#define NI_OVERLAY_CUTSCENE_23                 0xE3
#define NI_OVERLAY_CUTSCENE_24                 0xE4
#define NI_OVERLAY_CUTSCENE_25                 0xE5
#define NI_OVERLAY_CUTSCENE_26                 0xE6
#define NI_OVERLAY_CUTSCENE_27                 0xE7
#define NI_OVERLAY_CUTSCENE_28                 0xE8
#define NI_OVERLAY_CUTSCENE_29                 0xE9
#define NI_OVERLAY_CUTSCENE_2A                 0xEA
#define NI_OVERLAY_CUTSCENE_2B                 0xEB
#define NI_OVERLAY_CUTSCENE_2C                 0xEC
#define NI_OVERLAY_CUTSCENE_2D                 0xED
#define NI_OVERLAY_CUTSCENE_2E                 0xEE
#define NI_OVERLAY_CUTSCENE_32                 0xEF
#define NI_OVERLAY_CUTSCENE_33                 0xF0
#define NI_OVERLAY_CUTSCENE_34                 0xF1
#define NI_OVERLAY_CUTSCENE_35                 0xF2
#define NI_OVERLAY_CUTSCENE_3C                 0xF3
#define NI_OVERLAY_CUTSCENE_3D                 0xF4
#define NI_OVERLAY_CUTSCENE_3E                 0xF5
#define NI_OVERLAY_CUTSCENE_3F                 0xF6
#define NI_OVERLAY_CUTSCENE_44                 0xF7
#define NI_OVERLAY_CUTSCENE_45                 0xF8
#define NI_OVERLAY_CUTSCENE_52                 0xF9
#define NI_OVERLAY_CUTSCENE_54                 0xFA
#define NI_OVERLAY_CUTSCENE_55                 0xFB
#define NI_OVERLAY_CUTSCENE_56                 0xFC
#define NI_OVERLAY_CUTSCENE_57                 0xFD
#define NI_OVERLAY_CUTSCENE_63                 0xFE
