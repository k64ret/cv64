...
This is a numeric identifier used to distinguish the object from the rest, and to know where the object's associated code and files (if any) can be found.
